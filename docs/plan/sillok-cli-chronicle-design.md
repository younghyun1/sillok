...
Sillok is a Rust CLI for agentic daily work logging. It records natural-language work notes, objectives, amendments, and retractions into one user-global local store while exposing deterministic JSON for autonomous harnesses.
